...
<script type="text/javascript" src="../se2/package/dist/js/service/HuskyEZCreator.js" charset="utf-8"></script>
...
$(function(){
 ...
 sSkinURI: "../se2/package/dist/SmartEditor2Skin.html", 
 htParams : {
...
action="<%=request.getContextPath()%>/SmartEditorServlet">
...
<label for="ir1"> 간단한 가입 인사를 적어 주세요^o^ </label><br>
<textarea name="ir1" id="ir1" rows="10" cols="100"
style="width: 766px; height: 412px; display: none;"></textarea><br>
