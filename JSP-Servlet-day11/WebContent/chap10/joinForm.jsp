...
<body>
	...
	<form action="join.do" method="post" name="frm">
		<table>
			...
			<tr>
				<td>아이디</td>
				<td><input type="text" name="useid" size="20" id="useid">*<input type="hidden" name="reid" size="20">
			...
			<tr>
				<td>등급</td>
				<td><input type="radio" name="grade" id="nomal" value="0" checked="checked">
					<label for="namal">일반회원</label>
